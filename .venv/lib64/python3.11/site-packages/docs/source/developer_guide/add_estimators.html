...
<link rel="preload" as="script" href="../../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=dfe6caa3a7d634c4db9b" />
  <script src="../../../../../../../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=dfe6caa3a7d634c4db9b"></script>
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv/lib64/python3.11/site-packages/docs/source/developer_guide/add_estimators';</script>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/executablebooks/jupyter-book/issues/new?title=Issue%20on%20page%20%2F.venv/lib64/python3.11/site-packages/docs/source/developer_guide/add_estimators.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../_sources/.venv/lib64/python3.11/site-packages/docs/source/developer_guide/add_estimators.rst" target="_blank"
...
<ul class="simple">
<li><p>ensure that code also meets <code class="docutils literal notranslate"><span class="pre">sktime's</span></code> <a class="reference internal" href="documentation.html#developer-guide-documentation"><span class="std std-ref">documentation</span></a> standards.</p></li>
...
<li><p>if the estimator relies on soft dependencies, or adds new soft dependencies, the steps in the <a class="reference internal" href="dependencies.html#dependencies"><span class="std std-ref">“dependencies”
