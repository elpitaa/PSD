...
<html lang="en" data-content_root="../../../../../../../../" >
  ...
  <head>
    ...
    <title>Partition based time series clustering in sktime &#8212; My sample book</title>
...
<link rel="preload" as="script" href="../../../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=dfe6caa3a7d634c4db9b" />
  <script src="../../../../../../../../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=dfe6caa3a7d634c4db9b"></script>
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv/lib/python3.11/site-packages/docs/source/examples/clustering/partition_based_clustering';</script>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/executablebooks/jupyter-book/issues/new?title=Issue%20on%20page%20%2F.venv/lib/python3.11/site-packages/docs/source/examples/clustering/partition_based_clustering.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../../_sources/.venv/lib/python3.11/site-packages/docs/source/examples/clustering/partition_based_clustering.ipynb" target="_blank"
...
<div id="jb-print-docs-body" class="onlyprint">
    <h1>Partition based time series clustering in sktime</h1>
    <!-- Table of contents -->
...
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#k-partition-algorithms">K-partition algorithms</a><ul class="nav section-nav flex-column">
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#center-initialisation">Center initialisation</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#assignment-distance-measure">Assignment (distance measure)</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#updating-centroids">Updating centroids</a></li>
</ul>
</li>
...
<div id="searchbox"></div>
  ...
  <section class="tex2jax_ignore mathjax_ignore" id="partition-based-time-series-clustering-in-sktime">
<h1>Partition based time series clustering in sktime<a class="headerlink" href="#partition-based-time-series-clustering-in-sktime" title="Link to this heading">#</a></h1>
<p>Partition based clustering algorithms for time series are those where k
clusters are created from n time series. Each time series inside a cluster
are homogeneous (similar) to each other and heterogeneous (dissimilar) to
those outside the cluster.</p>
<p>To measure homogeneity and place a time series into a cluster, a metrics is
...
and is said to be a part of that cluster.</p>
<p>Currently, in Sktime there are 2 supported partition algorithms supported.
They are: K-means and K-medoids. These will be demonstrated below</p>
<section id="imports">
<h2>Imports<a class="headerlink" href="#imports" title="Link to this heading">#</a></h2>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ipython2 notranslate"><div class="highlight"><pre><span></span>from sklearn.model_selection import train_test_split
...
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ipython2 notranslate"><div class="highlight"><pre><span></span>X, y = load_arrow_head(return_X_y=True)
...
<section id="k-partition-algorithms">
<h2>K-partition algorithms<a class="headerlink" href="#k-partition-algorithms" title="Link to this heading">#</a></h2>
<p>K-partition algorithms are those that seek to create k clusters and assign
...
<li>Repeat assignment and updating until convergence</li>
<br>
<section id="center-initialisation">
<h3>Center initialisation<a class="headerlink" href="#center-initialisation" title="Link to this heading">#</a></h3>
<p>Center initialisation is the first step and has been found to be critical in
...
<ul>
    <li> K-means, K-medoids supported center initialisation:
        <ul>
            ...
            centers are then generated using the same method. This means each
...
<section id="assignment-distance-measure">
<h3>Assignment (distance measure)<a class="headerlink" href="#assignment-distance-measure" title="Link to this heading">#</a></h3>
<p>How a time series is assigned to a cluster is based on its distance from it to
...
<section id="updating-centroids">
<h3>Updating centroids<a class="headerlink" href="#updating-centroids" title="Link to this heading">#</a></h3>
<p>Center updating is key to the refinement of clusters to improve their quality.
How this is done depends on the algorithm, but the following are supported</p>
<ul>
    <li> K-means
        <ul>
            ...
            alignment when determining an average series. This provides a
...
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ipython2 notranslate"><div class="highlight"><pre><span></span>k_means = TimeSeriesKMeans(
...
<div class="cell_output docutils container">
<div class="output text_plain highlight-myst-ansi notranslate"><div class="highlight"><pre><span></span>&lt;Figure size 360x720 with 0 Axes&gt;
</pre></div>
</div>
<img alt="../../../../../../../../_images/1c2322c03e4f704aa9459967d99f47c742d0d85b68d925835a028148d76ccbb1.png" src="../../../../../../../../_images/1c2322c03e4f704aa9459967d99f47c742d0d85b68d925835a028148d76ccbb1.png" />
</div>
</div>
</section>
<section id="k-medoids">
<h2>K-medoids<a class="headerlink" href="#k-medoids" title="Link to this heading">#</a></h2>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ipython2 notranslate"><div class="highlight"><pre><span></span>k_medoids = TimeSeriesKMedoids(
    n_clusters=5,  # Number of desired centers
    init_algorithm=&quot;forgy&quot;,  # Center initialisation technique
    max_iter=10,  # Maximum number of iterations for refinement on training set
...
<div class="cell_output docutils container">
<div class="output text_plain highlight-myst-ansi notranslate"><div class="highlight"><pre><span></span>&lt;Figure size 500x1000 with 0 Axes&gt;
</pre></div>
</div>
<img alt="../../../../../../../../_images/fc88f826e54cdbe24ddd68c3c6396458f479b3e70b354fdf8131069d0259331c.png" src="../../../../../../../../_images/fc88f826e54cdbe24ddd68c3c6396458f479b3e70b354fdf8131069d0259331c.png" />
</div>
</div>
<p>The above shows the basic usage for K-medoids. This algorithm
...
of using dtw as the metric is given below.</p>
<div class="cell docutils container">
<div class="cell_input docutils container">
<div class="highlight-ipython2 notranslate"><div class="highlight"><pre><span></span>k_medoids = TimeSeriesKMedoids(
    n_clusters=5,  # Number of desired centers
...
<img alt="../../../../../../../../_images/fc88f826e54cdbe24ddd68c3c6396458f479b3e70b354fdf8131069d0259331c.png" src="../../../../../../../../_images/fc88f826e54cdbe24ddd68c3c6396458f479b3e70b354fdf8131069d0259331c.png" />
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./.venv/lib/python3.11/site-packages/docs/source/examples/clustering"
        },
