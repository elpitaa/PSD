...
with tab1:
    ...
    if uploaded_file is not None:
        ...
        with col1:
            ...
            if st.button("🔍 Analisis Audio & Verifikasi Speaker", type="primary", use_container_width=True):
...
with tab2:
    ...
    try:
        ...
        **📋 Cara Menggunakan:**
        ...
        # Tombol analisis di luar kolom agar lebih visible
        if wav_audio_data is not None:
            if st.button("🔍 Analisis Rekaman & Verifikasi Speaker", type="primary", use_container_width=True, key="analyze_recorded"):
